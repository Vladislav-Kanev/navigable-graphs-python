...
def download_siftsmall(output_dir):
...
def download_dataset(dataset_name, output_dir):
    ...
    #     download_sentence_embeddings(output_dir)
        ...
        print(
            f"Unknown dataset {dataset_name}. Please choose 'sift1m', 'glove', 'deep1b', 'fasttext', or 'sentence_embeddings'."
        )
